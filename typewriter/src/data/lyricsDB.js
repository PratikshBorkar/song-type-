// Simple lyrics database for popular songs
...
Though I don't deserve this, you look perfect tonight` // Add full lyrics here
  },
  {
...
// Get all songs (title & artist only)
export function getAllSongs() {
  return lyricsDB.map(({ title, artist }) => ({ title, artist }));
}

// Get lyrics by song title
export function getLyricsByTitle(title) {
  const song = lyricsDB.find(s => s.title === title);
