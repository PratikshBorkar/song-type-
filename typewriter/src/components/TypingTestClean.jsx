...
const TypingTest = () => {
  const generateMultiLineSentence = () => {
    ...
    while (combinedText.length < 350 && sentenceCount < 8) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white px-4">
      <h1 className="text-4xl font-bold mb-8 text-blue-400">⚡ Typing Test</h1>
      ...
      {/* Text Display Box - 4-5 lines in grey */}
      <div className="w-full max-w-4xl mb-8">
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700">
          <div className="text-2xl leading-relaxed font-mono text-gray-400 min-h-[160px]">
            {getColoredText()}
          </div>
        </div>
      </div>
      ...
      {/* Results Section - Only show WPM popup after timer ends */}
        ...
        <div className="mt-8 text-center bg-gray-800 p-6 rounded-lg border border-gray-700">
          ...
          <div className="flex justify-center gap-8 mb-6">
            <div className="text-center">
              ...
              <p className="text-4xl font-bold text-green-400">{wpm} WPM</p>
            </div>
            <div className="text-center">
